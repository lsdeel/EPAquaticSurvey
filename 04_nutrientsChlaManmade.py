...
nlaWaterChemRes = nlaWaterChem[nlaWaterChem.LAKE_ORIGIN12 == 'MAN_MADE']
...
nlaWaterChemRes = nlaWaterChemDecTemp[nlaWaterChemDecTemp.LAKE_ORIGIN12 == 'MAN_MADE']
nlaWaterChemRes = nlaWaterChemDecTemp[nlaWaterChemDecTemp.NTL_RESULT < 8]
...
plt.xticks(ticks = np.linspace(0, 2100, 4))
plt.yticks(np.arange(0, 601, 200, dtype=int))
plt.xlabel(r'total P')
plt.ylabel(r'$\mathrm{chl \/ (}\mu g \/ L^{-1})$')
...
fig.savefig(wd+'/output/figure/nutrientsChla/manMadeDecreaseTemp.png')
...
nlaWaterChemRes = nlaWaterChemDecTemp20degPlus[nlaWaterChemDecTemp20degPlus.LAKE_ORIGIN12 == 'MAN_MADE']
nlaWaterChemRes = nlaWaterChemDecTemp20degPlus[nlaWaterChemDecTemp20degPlus.NTL_RESULT < 8]
...
plt.text(400, 200, 
         '$y$ = {:1.1f} $x$ + {:1.0f},\n$r^2$ = {:1.2f}, $p$ = {:1.4f}'.format(a,b, r**2, p))
plt.title('total P versus Chlx a', loc = 'center')
plt.xticks(ticks = np.linspace(0, 1000, 6))
plt.yticks(np.arange(0, 301, 100, dtype=int))
plt.xlabel(r'total P')
plt.ylabel(r'$\mathrm{chl \/ (}\mu g \/ L^{-1})$')
...
fig.savefig(wd+'/output/figure/nutrientsChla/manMadeDecreaseTemp20degPlus.png')
...
nlaWaterChemDecTempBig = nlaWaterChemDecTemp[nlaWaterChemDecTemp.AREA_HA >= 10]
...
nlaWaterChemRes = nlaWaterChemDecTempBig[nlaWaterChemDecTempBig.LAKE_ORIGIN12 == 'MAN_MADE']
...
fig.savefig(wd+'/output/figure/nutrientsChla/manMadeDecreaseTempBigThan10HA.png')
